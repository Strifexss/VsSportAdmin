<table class="w-full bg-zinc-900 text-white rounded-lg shadow-md">
    ...
    <tbody>
        ...
        <tr class="hover:bg-gray-800" data-id="{{ $grade->id }}">
            <td class="py-3 px-4 border-b border-gray-600">{{ $grade->id }}</td>
            <td class="py-3 px-4 border-b border-gray-600">{{ $grade->nome }}</td>
